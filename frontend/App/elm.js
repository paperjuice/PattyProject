	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Here insert icon'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
	...
	switch (_p0.ctor) {
		...
		case 'Admin':
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Here you can add new workers'),
					_1: {ctor: '[]'}
				});
		case 'AdminRoom':
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Here you see the room status, probabil ca ar trebui sa poti sa vezi toate camerele, donno'),
					_1: {ctor: '[]'}
				});
		case 'Cleaner':
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Cleaner view based on floor'),
					_1: {ctor: '[]'}
				});
		case 'Reception':
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Reception where it can see all the floors/rooms'),
					_1: {ctor: '[]'}
				});
		default:
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('The path doesn\'t exist :('),
					_1: {ctor: '[]'}
				});
	}
};
...
var _user$project$Main$Cleaner = function (a) {
	return {ctor: 'Cleaner', _0: a};
};
var _user$project$Main$AdminRoom = function (a) {
	return {ctor: 'AdminRoom', _0: a};
};
...
var _user$project$Main$matcher = _evancz$url_parser$UrlParser$oneOf(
	{
		...
		_1: {
			...
			_1: {
				...
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_user$project$Main$Register,
					_evancz$url_parser$UrlParser$s('register')),
				_1: {
					ctor: '::',
					_0: A2(
						_evancz$url_parser$UrlParser$map,
						_user$project$Main$Admin,
						_evancz$url_parser$UrlParser$s('admin')),
					_1: {
						ctor: '::',
						_0: A2(
							_evancz$url_parser$UrlParser$map,
							_user$project$Main$AdminRoom,
							A2(
						...
						_1: {
							...
							_0: A2(
								_evancz$url_parser$UrlParser$map,
								_user$project$Main$Cleaner,
								A2(
									_evancz$url_parser$UrlParser_ops['</>'],
									_evancz$url_parser$UrlParser$s('cleaner'),
									_evancz$url_parser$UrlParser$int)),
							_1: {
								ctor: '::',
								_0: A2(
									_evancz$url_parser$UrlParser$map,
									_user$project$Main$Reception,
									_evancz$url_parser$UrlParser$s('reception')),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$Main$matchLocation = function (location) {
	var _p1 = A2(_evancz$url_parser$UrlParser$parseHash, _user$project$Main$matcher, location);
	if (_p1.ctor === 'Just') {
		return _p1._0;
	} else {
		return _user$project$Main$RouteNotFound;
	}
};
